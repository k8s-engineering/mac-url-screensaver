...
// A screen saver that displays configurable web views, with per-screen URL
// support for multi-monitor setups (up to 6 screens).
@interface WebViewScreenSaverView : ScreenSaverView

@property(nonatomic, strong) WVSSConfigController *configController;

/// The detected screen index for this view instance (0-based).
@property(nonatomic, assign, readonly) NSInteger screenIndex;
